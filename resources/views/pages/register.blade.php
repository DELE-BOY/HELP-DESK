...
<html lang="en">
  ...
  <base>
    ...
    <title>FRESHERS HELP DESK SIGN-UP </title> <!--Registration page-->
          ...
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                ...
                <form method="POST" action="{{route("register-user")}}" id="loginform">
            ...
            <div class="card text-white  d-md-down-none" style="width:44%; background-color: #004282;">
              ...
              <div class="card-body text-center">
                <div>
                  ...
                  <h2>Welcome</h2> 
                  <p>This is the sign up page where you register with your correct details</p>
                  <a class="btn btn-lg btn-outline-light mt-3"  href="{{route('login')}}"> <i classfar fa-house-return" style="margin-right:10px;">
                  </i> LOGIN</a>
                </div>
              </div>
            </div>
